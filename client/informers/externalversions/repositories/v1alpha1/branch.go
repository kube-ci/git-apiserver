...
import (
	...
	v1alpha1 "kube.ci/git-apiserver/client/listers/repositories/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RepositoriesV1alpha1().Branches(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RepositoriesV1alpha1().Branches(namespace).Watch(options)
			},
		},
		&repositories_v1alpha1.Branch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *branchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&repositories_v1alpha1.Branch{}, f.defaultInformer)
}
