...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("repositorybindings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Git().V1alpha1().RepositoryBindings().Informer()}, nil
