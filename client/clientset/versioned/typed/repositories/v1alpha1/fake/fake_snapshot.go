...
var snapshotsResource = schema.GroupVersionResource{Group: "repositories.git.kube.ci", Version: "v1alpha1", Resource: "snapshots"}

var snapshotsKind = schema.GroupVersionKind{Group: "repositories.git.kube.ci", Version: "v1alpha1", Kind: "Snapshot"}
