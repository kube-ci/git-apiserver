...
var repositoriesResource = schema.GroupVersionResource{Group: "git.kube.ci", Version: "v1alpha1", Resource: "repositories"}

var repositoriesKind = schema.GroupVersionKind{Group: "git.kube.ci", Version: "v1alpha1", Kind: "Repository"}
