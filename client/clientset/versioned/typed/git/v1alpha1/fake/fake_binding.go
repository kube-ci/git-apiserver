...
var bindingsResource = schema.GroupVersionResource{Group: "git.kube.ci", Version: "v1alpha1", Resource: "bindings"}

var bindingsKind = schema.GroupVersionKind{Group: "git.kube.ci", Version: "v1alpha1", Kind: "Binding"}
