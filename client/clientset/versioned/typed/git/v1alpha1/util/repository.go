...
func CreateOrPatchRepository(c cs.GitV1alpha1Interface, meta metav1.ObjectMeta, transform func(alert *api.Repository) *api.Repository) (*api.Repository, kutil.VerbType, error) {
...
func UpdateRepositoryStatus(c cs.GitV1alpha1Interface, cur *api.Repository, transform func(*api.RepositoryStatus) *api.RepositoryStatus, useSubresource ...bool) (*api.Repository, error) {
